...
public class DialogueEvents
{
    ...
    public event Action<string, GameObject> onObjectDialogue;
    public void ObjectDialogue(string knotName, GameObject gameObject)
    {
        if (onObjectDialogue != null)
        {
            onObjectDialogue(knotName, gameObject);
        }
    }
